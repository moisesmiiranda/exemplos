...
public class Main {
	...
	private static List<String> itens = Arrays.asList("computador", "papel", "caneta", "cortina", "gaveta");
	...
	private static void executar1() {
		/*
		 * 1. Ordenar
		 * 2. Manter somente os 3 primeiros elementos
	...
	private static void executar2() {
		/*
		 * 1. Filtrar apenas elementos que contém a letra 'C'
